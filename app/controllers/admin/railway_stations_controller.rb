  ...
  class RailwayStationsController < Admin::BaseController
    ...
    def update_position
      ...
      if @railway_station.update_position(route, params[:number])
        redirect_to admin_route_url(route), notice: 'Station index was successfully updated.'
      else
    ...
    def update_time
      ...
      if @railway_station.update_arrival_time(route, params[:arrival_time]) \
        ...
        redirect_to admin_route_url(route), notice: 'Times were successfully updated.'
      else
        redirect_to admin_route_url(route)
      end
    end
